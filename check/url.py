                            ...
                            try:
                                ...
                                if response.status_code >= 400:
                                    if response.status_code != 404:
                                        ...
                                        print(f"{Fore.RED}[Fail (return 404)]{Fore.RESET} URL {Fore.BLUE}{url}{Fore.RESET} in file {Fore.BLUE}{filename}{Fore.RESET} returned status code {Fore.YELLOW}{response.status_code}{Fore.RESET} (Not found)")
                                    input("Please check the URL manually and press Enter to continue...\n")
                                    # Handle logic for status code 400 and above here
                                else:
                                    print("*", end="")
                            except requests.exceptions.RequestException as e:
                                print(f"{Fore.YELLOW}[Warning]{Fore.RESET} Unable to access URL {Fore.BLUE}{url}{Fore.RESET} in file {Fore.BLUE}{filename}{Fore.RESET}: {Fore.RED}{e}{Fore.RESET}")
                                input("Please check the URL manually and press Enter to continue...\n")
                except IOError as e:
                    print(f"{Fore.RED}[Fail]{Fore.RESET} Can not open file {Fore.BLUE}{filename}{Fore.RESET} : {Fore.RED}{e}{Fore.RESET}")
                    input("Please check the file permissions and coding, press Enter to continue...\n")
                except yaml.YAMLError as e:
                    print(f"{Fore.RED}[Fail]{Fore.RESET} Error parsing YAML for file {Fore.BLUE}{filename}{Fore.RESET} : {Fore.RED}{e}{Fore.RESET}")

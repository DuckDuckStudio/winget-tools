    ...
    internal class Program
    {
        ...
        static bool IsExcluded(string url)
        {
            ...
            [
                ...
                "https://github.com/ClassicOldSong/Apollo/releases/download/v0.2.9-alpha.3/Apollo.exe", "https://dtapp-pub.dingtalk.com/dingtalk-desktop/win_installer/Release/DingTalk_v7.6.15.91110808.exe", "https://download.ydstatic.com/notewebsite/downloads/YNote.exe", // WIP

...
namespace checker
{
    internal static class Program
    {
        ...
        private static readonly HashSet<string> ExcludedDomains = new(StringComparer.OrdinalIgnoreCase) {
            ...
            "https://www.deezer.com/", ".mil", "https://download.wondershare.com/cbs_down/", "https://openrainbow.com/downloads/Rainbow_Installer", // 无法验证
            "https://downloads.mysql.com/", "https://swcdn.apple.com/content/downloads/", "sourceforge.net", "https://cdn1.waterfox.net/waterfox/releases/", "https://downloads.tableau.com/public/", "https://sp.thsi.cn/staticS3/mobileweb-upload-static-server.file/app_6/downloadcenter/THS_insoft", "https://files02.tchspt.com/down/", "https://cdn-dl.yinxiang.com/", "https://download.mono-project.com/archive/", "https://cdn-resource.aunbox.cn/", "https://www.fischertechnik.de/-/media/fischertechnik/fite/service/downloads/robotics/robo-pro/documents/update-robopro.ashx", "https://azcopyvnext-awgzd8g7aagqhzhe.b02.azurefd.net/releases", "https://files03.tchspt.com/down/iview466_plugins_setup.exe", "https://file2.speedtest.cn/pc-pro/win64/网维助手", "https://www.wagnardsoft.com/DDU/download/", "https://static.cebbank.com/static/cebbank/cebent/ass1/CEBAssistant.zip", "https://www.autodesk.com/support", "https://ftp.gnu.org", "http://www.mathgv.com/dfiles/MathGV4_1_Setup.msi", "https://cdbemulator-dmhwaeevbhd3e9f8.b02.azurefd.net/msi/pipeline/", "https://ggnome.com/", "https://download-center.epson.com", "https://codeberg.org", // 假403
        ...
        private static HashSet<string> FindUrls(YamlNode node, string failureLevel)
        {
            ...
            if (node is YamlMappingNode mappingNode)
            {
                ...
                {
                    HashSet<string> mustCheckManifestKeys =
                    [
                        "InstallerUrl", "ReturnResponseUrl"
                    ];

                    HashSet<string> allManifestKeys =
                    [
                        .. mustCheckManifestKeys,
                    ...
                    if (entry.Key is YamlScalarNode { Value: not null } keyNode)
                    {
                        ...
                        {
                            // 如果是 详细，检查所有 URL
                            flag = allManifestKeys.Contains(keyNode.Value);
                        }
                        else
                        {
                            // 否则，始终检查 InstallerUrl 和 ReturnResponseUrl
                            flag = mustCheckManifestKeys.Contains(keyNode.Value);
                        }

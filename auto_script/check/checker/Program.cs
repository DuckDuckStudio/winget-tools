    ...
    internal class Program
    {
        ...
        static bool IsExcluded(string url)
        {
            ...
            [
                ...
                "https://github.com/GopeedLab/gopeed/releases/download/v1.7.0/Gopeed-v1.6.12-windows-amd64.zip", "https://featherwallet.org/files/releases/win-installer/FeatherWalletSetup-2.4.5.exe", // WIP
            ];
